...
<nav class="fixed top-0 w-full bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded drop-shadow-md z-50 dark:bg-gray-900 md:w-full {{ ($title === "Login") ? 'hidden ' : 'inline' }}">
    <div class="container grid grid-cols-3 mx-auto">
        ...
        {{-- ?? user profile --}}
        <div class="flex items-center md:ml-5 {{ ($title === "Home") ? 'hidden ' : 'inline' }}">
            <img id="avatarButton" type="button" data-dropdown-toggle="userDropdown" data-dropdown-placement="bottom-start" class="w-10 h-10 rounded-full cursor-pointer" src="{{ asset("img/ilham-bulet.png") }}" alt="User dropdown">
        ...
        <!-- Dropdown menu -->
            <div id="userDropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                ...
                <div>Ilham Firdaus</div>
                <div class="font-medium truncate">ilhamfir09@gmail.com</div>
                </div>
