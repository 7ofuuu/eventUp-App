...
<div id="default-carousel" class="relative  md:mt-8" data-carousel="static">
      <!-- Carousel wrapper -->
...
{{-- <a href="#" class="flex flex-row items-center bg-white rounded-lg border shadow-md md:hidden  md:flex-col md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
    <img class="object-cover w-56 h-56 rounded-t-lg md:h-auto md:w-48 md:rounded-none md:rounded-l-lg" src="{{ asset("img/banner-1.jpeg") }}" alt="">
    <div class="flex flex-col justify-between p-4 leading-normal">
