    ...
    def post(self, request):
        try:
            ...
            # Forget Password
                ...
                mail_subject = 'Tautan Ubah Password Akun EventUp Kamu.'
    ...
    def post(self, request):
        try:
            ...
            if result['success'] and result['action'] == 'signup' and form.is_valid():
                ...
                '''Begin Email Sending '''
                current_site = get_current_site(request)
                mail_subject = 'Aktivasi akun EventUp kamu!'
        ...
        try:
            if request.user.is_superuser:
                if kwargs.get('tema_event'):
                    event_list = EventRecord.objects.filter(tema_event=kwargs['tema_event']).order_by('-id')
                    print('aa')
